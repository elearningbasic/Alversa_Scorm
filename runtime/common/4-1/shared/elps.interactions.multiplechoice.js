    ...
    multiplechoice: {
        ...
        getAssistanceInfo: function(){
			...
			switch(wbt.metadata.language){
				case "_de":		
					html = "" +
						"Falsche Antworten wurden rot markiert. Wichtig: Mögliche richtige Antworten, die Sie " +
						"noch nicht ausgewählt haben, werden nicht hervorgehoben!";
					break;
				case "_en":
					html = "" +
						"Incorrect answers are marked in red. Note: Correct answers that you have " +
						"not already selected are not highlighted!";
					break;
			};
			return html;
		},
        ...
        getEvaluationHelp: function(){
			...
			switch(wbt.metadata.language){
				case "_de":
					...
					html = "" +
						"<table class='mcEvaluationHelp' border='0' cellspacing='0' cellpadding='0'>" +
							"<tr>" +
								"<td colspan='2'>" +
							...
							"<tr>" +
								"<td>" +
									"<span class='mcEvaluationHelp_passed'></span>" +
								"</td>" +
								"<td>" +
							...
							"<tr>" +
								"<td>" +
									"<span class='mcEvaluationHelp_failed'></span>" +
								"</td>" +
								"<td>" +
							...
							"<tr>" +
								"<td>" +
									"<span class='mcEvaluationHelp_incomplete'></span>" +
								"</td>" +
								"<td>" +
							...
							"<tr>" +
								"<td>" +
									"<span class='mcEvaluationHelp_hasFeedback'></span>" +
								"</td>" +
								"<td>" +
        ...
        interactionChoiceTemplate: function(){
            return "" +
                "<div id='div{CID}' class='clearfix choice'>" +
                    "<input id='choice{CID}' type='checkbox' data-label='{TEXT}' data-feedback='{FEEDBACK}' data-role='none' />" +
                "</div>";
        },
        ...
        applyQuestionStatus: function(status){
            ...
            $.each(q.answers, function(i,item){
                ...
                if(!$("#choice"+item.id).parent().hasClass("prettycheckbox")){
